...
public class NativeLibraryLoader {
    ...
    private static final String sharedLibraryName = Environment.getSharedLibraryName("prql4j");
    private static final String jniLibraryName = Environment.getJniLibraryName("prql4j");
    private static final /* @Nullable */ String fallbackJniLibraryName =
            Environment.getFallbackJniLibraryName("prql4j");
    private static final String jniLibraryFileName = Environment.getJniLibraryFileName("prql4j");
    private static final /* @Nullable */ String fallbackJniLibraryFileName =
            Environment.getFallbackJniLibraryFileName("prql4j");
    private static final String tempFilePrefix = "libprql4jjni";
